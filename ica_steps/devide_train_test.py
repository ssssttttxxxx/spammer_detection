...
if __name__ == "__main__":
    ...
    attributes_name = ['reviewerID', 'friends_num', 'reviews_num', 'photo_num', 'degree', 'pos_reviews', 'neg_reviews',
                       'neu_reviews']  # degree variable is useless
    ...
    np.savetxt('../train_test_data_set/training_set.csv', x_train_np, delimiter=',', encoding='utf8', fmt='%s')
    np.savetxt('../train_test_data_set/test_set.csv', x_test_np, delimiter=',', encoding='utf8', fmt='%s')
    np.savetxt('../train_test_data_set/label_training_set.csv', y_train_np, delimiter=',', encoding='utf8', fmt='%s')
    np.savetxt('../train_test_data_set/label_test_set.csv', y_test_np, delimiter=',', encoding='utf8', fmt='%s')