...
def split_tarinset_testset(graph):
...
# split
X_train, X_test, Y_train, Y_test = split_tarinset_testset(graph)
...
filename = 'decision_tree_result/decision_tree_model%s.sav' % shuffle_stat
